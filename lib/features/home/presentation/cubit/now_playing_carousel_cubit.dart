...
import '../../../movies/domain/usecase/get_movies_now_playing_usecase.dart';
import 'carousel_state.dart';

class NowPlayingCarouselCubit extends Cubit<MoviesListState> {
  NowPlayingCarouselCubit(this._getMoviesNowPlayingUsecase)
  ...
  Future<void> loadMovies() async {
    ...
    try {
      final CoreBaseResponse<MoviesListEntity> response =
          await _getMoviesNowPlayingUsecase(_currentFilter);

      if (response.isError) {
        emit(MoviesListError('Erro ao carregar filmes'));
        return;
      }
